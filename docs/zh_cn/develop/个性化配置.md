...
您可以简单的将 `.github/ISSUE_TEMPLATE` 目录下的模板文件（`cn-bug-report.yaml`、`cn-feature-request.yaml`、`cn-others.yaml` 及对应的英文版 `en-*.yaml`）中 `MXX` 修改为您自己的项目名称，即可使用。
...
配置文件 `.prettierrc` , [具体规则](https://prettier.io/docs/en/options.html)
