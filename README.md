...
- [x] **辩论**
  ...
  - [x] **复盘异常关卡刷角色材料**
  - [x] **复盘异常关卡刷印象材料**
  - [x] **复盘异常关卡刷思绪残影**(更新至第19章Part2)
  - [x] **外勤委托**
- [x] **其他**
  - [x] **专属甜心**
  - [x] **逸梦**
  - [x] **好感度**
  - [x] **你我之间**（记录心情、准备物品、回应动态、习惯打卡）
  - [x] **试炼神殿**（每周一次，开启后每次运行时检查是否到达每周 400 上限）
  - [x] **未名市周任务**（每周一次，自动完成未名市中的周任务）
  - [x] **思绪张数任务**（往期活动关卡刷取思绪张数，不识别任务是否完成，仅支持设置多次辩论）
- [x] **限时活动**（限时活动任务请手动添加，并在活动结束后手动移除）
  - [x] **领取限时拼图活动代币**
  - [x] **购买限时活动免费祈愿盒**
  - [x] **领取限时翻格活动代币**
  - [x] **提交材料活动**
...
开发相关事项请查看文档 [开发前须知](./docs/zh_cn/develop/开发前须知.md) 。
...
- 本项目仅用于**个人编程学习、代码练习与技术交流**。任何其他第三方自行下载、复制、运行、二次修改并使用本项目的行为，均属于其独立自愿行为。在使用过程中，本项目可能存在意想不到的 Bug，因项目漏洞、文本理解有歧义、异常操作导致的账号问题等，本项目作者不承担任何责任，请在确保在阅读完用户手册后谨慎使用！
- 本项目上传至开源平台，仅用于个人代码备份、版本管理与维护等，无任何面向公众的工具分发、服务提供意图。
- 本项目严禁用于代练、批量挂机等牟利及违规行为。本项目仅供学习交流使用，不得用于商业用途。
